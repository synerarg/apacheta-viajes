  ...
  return (
    <section className="bg-primary">
      <div className="mx-auto w-[calc(100%-1rem)] max-w-[1440px] py-8">
        <div className="grid grid-cols-2 gap-3 sm:gap-6 md:flex md:items-center md:justify-between md:gap-4">
          {metrics.map((metric, index) => (
            ...
            >
              <div className="flex flex-col items-center md:px-8">
                <span className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl italic text-white">
                  {metric.value}
                </span>
