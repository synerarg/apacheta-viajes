...
function resolvePaymentStatusLabel(status: CheckoutOrderSummary["paymentStatus"]) {
  switch (status) {
    case "approved":
      return "Aprobado"
    case "reported":
...
function resolvePaymentMethodLabel(method: CheckoutOrderSummary["paymentMethod"]) {
  switch (method) {
    ...
    <main className="min-h-screen bg-off-white pb-16 pt-28">
      <div className="mx-auto w-[calc(100%-1rem)] max-w-[1440px]">
        <div className="mx-auto max-w-[960px]">
          ...
          <p className="mb-10 max-w-[720px] font-sans text-base leading-relaxed text-dark-brown">
          ...
          {orders.length === 0 ? (
            <div className="border border-dark-brown/20 bg-white p-8">
              ...
              <p className="mb-6 font-sans text-sm leading-relaxed text-subtle">
                Cuando completes una compra, el historial va a quedar disponible en
                esta sección.
              </p>
              <Link
                href="/#paquetes"
                        ...
                        >
                          <div>
                            <p className="text-xs text-primary">
                              {item.kind === "paquete" ? "Paquete" : "Experiencia"}
                            </p>
